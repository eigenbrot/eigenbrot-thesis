...
\input{Appendix/gradpak_cal_table}
...
as well as the total throughput are included in Table \ref{GPtesting:tab:GP_cal}
...
Table \ref{GPtesting:tab:GP_cal} contains measurements and Figure
