...
populations. Metallicity is peaked at \val{0.75}{\Zsol}, and we choose
...
the age generally increases, and above \val{1}{kpc} the light is
...
Figure \ref{891_2:fig:tau_Z} confirms this enrichment history. At all
...
``peak metallicity'' discovered in \S\ref{891_2:sec:tZ} (\val{\asim
  6}{Gyr}).
...
formation more recent than \val{6}{Gyr} (i.e., anything besides the
