...
we use the \val{0.2}{\Zsol}, \val{0.4}{\Zsol}, \val{1}{\Zsol}, and
\val{2.5}{\Zsol} metallicity bc03 diffusion k-means SSPs (see section
...
%%     unweighted fit. The dashed lines have a slope of 1. \emph{bottom:}
...
%% beyond what we be allowed by an unweighted fit (which is relatively
...
%% could apply to the unweighted fits IF we thought there was some
