...
The primary degeneracy in our fit parameters is the well known
...
\S\ref{891_2:sec:SFH}, below \val{0.4}{kpc} most of the measured light
...
As shown in Figure \ref{891_2:fig:MC_covar}, the majority of apertures
...
at \val{0.4}{kpc} (Chapter \ref{chap:891_1}) and therefore have a high
...
the oldest SSPs span a range of over \val{7}{Gyr} and thus the age
...
apertures this uncertainty is \asim 20\%, but there is a tail with
