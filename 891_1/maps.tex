...
\begin{figure}
  ...
  spectrum]{\label{891_1:fig:noise_vec}\fixspacing Characteristic
    ...
    in \S\ref{891_1:sec:maps}, here normalized between \val{5450}{\AA}
    $\leq \lambda \leq$ \val{5550}{\AA}. Vertical dashed lines
...
S/N in pixel units, where each pixel samples roughly \val{2}{\AA}.
...
\val{0.4}{\Zsol} and had extinction dictated by the model of
...
\val{210}{\kms} to match the characteristic resolution of the data at
...
number of underfilled bins is \asim 2 per pointing. In most cases
...
solution appears to be wrong by more than \val{\asim 100}{\kms},
