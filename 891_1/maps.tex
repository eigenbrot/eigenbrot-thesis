...
\begin{figure}
  ...
  spectrum]{\label{fig:noise_vec}\fixspacing Characteristic noise
...
\begin{figure}
  ...
  determination]{\label{fig:SN_sys}\fixspacing Systematics in fit
...
\begin{figure}
  ...
  S/N]{\label{fig:SN_rms}\fixspacing Precision of recovered parameters
    ...
    to results for model spectra described in Figure \ref{fig:SN_sys},
