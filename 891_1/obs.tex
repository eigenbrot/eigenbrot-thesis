...
\begin{figure}
  ...
  \caption{\label{fig:ASR_comp} Comparison of our \GP pointings to
    attenuation-corrected K-band light profiles measured by
...
\begin{figure*}
  ...
  \caption{\label{fig:pointings} NGC 891 \GP pointings (Table
    \ref{tab:targets}) overlaid on combined Subaru (V band)/West
    Mountain Observatory (R,G,B) image. The horizontal white lines
    denote the extent of the super-thin disk reported by
