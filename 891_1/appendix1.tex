...
\begin{figure*}[htb]
  \centering
  \includegraphics[width=0.4\textwidth]{891_1/figs/gradpak_map.pdf}
  \includegraphics[width=0.4\textwidth]{891_1/figs/gradpak_L_map.pdf}
\vskip -0.25in
\caption[\GP throughput and and FRD
losses]{\label{fig:TL_FRD}\fixspacing Maps of laboratory measurements
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{891_1/figs/gradpak_facefig.pdf}
  \caption[\GP face and polishing
  detail]{\label{fig:gradpak_face}\fixspacing Detail of \GP fiber face
...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{891_1/figs/gradpak_count_plots.pdf}
  \caption[\GP on-bench throughput
  performance]{\label{fig:count_tput}\fixspacing Left: Relative fiber
...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{891_1/figs/gradpak_Lplots.pdf}
  \caption[\GP on-bench FRD losses]{\label{fig:FRD_loss}\fixspacing
    Performance metrics for \GP. $L_\mathrm{FRD}$ (Equation
    \ref{eq:L_FRD}) as a function of slit location (right) and $T_4$
    (transmission through an f/4 aperture). Points are color-coded by
...
\centering
\vskip -1.25in
  \includegraphics[width=\textwidth]{891_1/figs/blaze_comp_land.pdf}
\vskip -1.25in
...
\begin{figure*}[htb]
  \centering
\vskip -1.25in
  \includegraphics[width=\textwidth]{891_1/figs/blaze_plot_land.pdf}
\vskip -1.25in
