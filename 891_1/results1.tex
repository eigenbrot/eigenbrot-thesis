...
\begin{figure*}[t]
  ...
  \caption{\label{fig:mab_data}\fixspacing Same as Figure
    \ref{fig:MW_heating}, but for the \GP data from NGC 891. Top:
    ...
    described for Figure \ref{fig:D4000_cuts}. Bottom: Representative
