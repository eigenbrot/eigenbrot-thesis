...
metal-dominated spectra is clear at \val{0.4}{kpc}, as highlighted by
the bottom panel. At \val{0.3}{kpc} Balmer absorption dominates, but at
...
correction correction shifts \Hda by only \val{-0.4\pm 0.3}{\AA},
...
stellar populations at \val{0.4}{kpc}. This is very close to the
...
\val{\asim 11}{Gyr} these indices can vary by almost the entire
...
``old'' populations across the vertical cut at \val{0.4}{kpc}; it is
