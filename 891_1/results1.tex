...
\begin{figure*}[t]
  ...
  \caption{\label{fig:mab_data} Same as Figure \ref{fig:MW_heating},
    but for the \GP data from NGC 891. Top: Normalized galaxy spectra
    at different heights, color-coded by intensity (see text for a
    description of how this image was made). The horizontal line
    marks the age break at \val{0.4}{kpc} described for Figure
    \ref{fig:D4000_cuts}. Bottom: Representative spectra at three
    different heights (labeled). Prominent spectral features are
    labeled at the boundary between the two panels.}
\end{figure*}
...
\ref{fig:mab_data} presents our data for direct comparison to Figure
\ref{fig:MW_heating}. This was made by sorting spectra from all
...
spectra in Figure \ref{fig:MW_heating}, the individual spectra were
...
blueward of \val{3800}{\AA} (Figure \ref{fig:sky_flux_comp}), and we
...
The lack of discernable gradients is perhaps unsurprising given the
...
The differences in metallicity seen at intermedate radii and larger
...
%     \S\ref{sec:index_defn} plotted as a function of height above the
