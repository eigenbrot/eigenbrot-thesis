...
\begin{figure}
  ...
  calibration]{\label{fig:wave_err}\fixspacing Estimated accuracy and
...
\begin{figure}
  ...
  \caption[Sky subtraction example]{\label{fig:skysub_comp}\fixspacing Example of large
...
\begin{figure}
  ...
  sizes]{ \label{fig:sky_flux_comp}\fixspacing Flux calibration test
...
\begin{figure}
  ...
  fibers]{\label{fig:dispfunc}\fixspacing Instrumental resolution as
